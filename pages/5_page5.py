...
df2 = pd.read_csv("data/data1.csv", encoding="latin1")

df2["latitude"] = pd.to_numeric(df2.iloc[:, 2], errors="coerce")
df2["longitude"] = pd.to_numeric(df2.iloc[:, 1], errors="coerce")
...
# 라인 차트
chart_data = pd.DataFrame(np.random.randn(20,4), columns=["a","b","c"])
